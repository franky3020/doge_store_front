...
export interface IAdminPageV2Props {

}

export interface IAdminPageV2State {
    products: ProductEntity[],
    addProductModelShow: boolean
}

export default class AdminPageV2 extends React.Component<IAdminPageV2Props, IAdminPageV2State> {
    ...
    constructor(props: IAdminPageV2Props) {
        super(props);
